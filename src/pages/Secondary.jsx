...
const Secondary = () => {
  ...
  useEffect(() => {
    document.title = 'Trung học cơ sở';
    fetchCategories();
  }, []);
    ...
    <>
        ...
        <div className="container-fluid page-header py-5 wow fadeIn" data-wow-delay="0.1s">
            <div className="container text-center py-5">
                <h1 className="display-2 text-white mb-4">Trung học cơ sở</h1>
                <nav aria-label="breadcrumb">
                    <ol className="breadcrumb justify-content-center mb-0">
                        <li className="breadcrumb-item"><a href="/home">Trang chủ</a></li>
                        <li className="breadcrumb-item"><a>Khóa học</a></li>
                        <li className="breadcrumb-item text-white" aria-current="page">Trung học cơ sở</li>
                    </ol>
                </nav>
            </div>
        </div>
